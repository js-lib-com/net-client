...
public class EventReaderUnitTest extends TestCase {
	...
	private static final Map<String, Class<? extends Event>> MAPPINGS = new HashMap<>();
	static {
	...
	private static EventReader reader(String eventStream) {
		try {
			return new EventReader(MAPPINGS, new ByteArrayInputStream(eventStream.getBytes("UTF-8")));
